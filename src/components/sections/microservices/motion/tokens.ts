export const scalabilityMotionTokens = {
  ...
  targets: {
    ...
    hover: {
      core: { opacity: 1, transform: "scale(1.015)" },
      edges_glow: { opacity: 0.96, transform: "scale(1.01)" },
      clone_a: { opacity: 1, transform: "scale(1.01)" },
      clone_b: { opacity: 1, transform: "scale(1.01)" },
      clone_c: { opacity: 1, transform: "scale(1.01)" },
      clone_d: { opacity: 0.62, transform: "scale(1.005)" },
      clone_e: { opacity: 0.62, transform: "scale(1.005)" },
      clone_f: { opacity: 0.62, transform: "scale(1.005)" },
      clone_g: { opacity: 0.62, transform: "scale(1.005)" },
      clone_h: { opacity: 0.62, transform: "scale(1.005)" },
      clone_i: { opacity: 0.62, transform: "scale(1.005)" },
      clone_j: { opacity: 0.62, transform: "scale(1.005)" },
      clone_k: { opacity: 0.62, transform: "scale(1.005)" },
      clone_l: { opacity: 0.62, transform: "scale(1.005)" },
      clone_m: { opacity: 0.62, transform: "scale(1.005)" },
      route_r1: { opacity: 0.36 },
      route_r2: { opacity: 0.36 },
      route_r3: { opacity: 0.32 },
      route_r4: { opacity: 0.32 }
    },
    active_locked: {
      core: { opacity: 1, transform: "scale(1.015)" },
      edges_glow: { opacity: 0.96, transform: "scale(1.01)" },
      ...
      clone_b: { opacity: 1, transform: "scale(1.01)" },
      clone_c: { opacity: 1, transform: "scale(1.01)" },
      clone_d: { opacity: 1, transform: "scale(1.005)" },
      clone_e: { opacity: 1, transform: "scale(1.005)" },
      clone_f: { opacity: 1, transform: "scale(1.005)" },
      clone_g: { opacity: 1, transform: "scale(1.005)" },
      clone_h: { opacity: 1, transform: "scale(1.005)" },
      clone_i: { opacity: 1, transform: "scale(1.005)" },
      clone_j: { opacity: 1, transform: "scale(1.005)" },
      clone_k: { opacity: 1, transform: "scale(1.005)" },
      clone_l: { opacity: 1, transform: "scale(1.005)" },
      clone_m: { opacity: 1, transform: "scale(1.005)" },
      route_r1: { opacity: 1 },
      route_r2: { opacity: 1 },
      route_r3: { opacity: 1 },
      route_r4: { opacity: 1 }
